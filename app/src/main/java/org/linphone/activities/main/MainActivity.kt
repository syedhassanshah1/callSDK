        ...
        override fun onRegistrationStateChanged(
            ...
            if (cfg == proxyConfigToCheck) {
                ...
                if (state == RegistrationState.Ok) {
                    binding.content.btnCallTest?.setOnClickListener {
                        coreContext.startCall("7777")
                    }
...
//                    leaveAssistantEvent.value = Event(true)
                    ...
                    openAssistant()
                    Toast.makeText(this@MainActivity, "Unable to connect to server", Toast.LENGTH_SHORT).show()
//                    invalidCredentialsEvent.value = Event(true)
    ...
    fun createProxyConfig(accountCreator: AccountCreator) {
        waitForServerAnswer.value = true
        coreContext.core.addListener(coreListener)

        accountCreator.username = "1090"
        accountCreator.password = "ab0000"
        accountCreator.domain = "ovs3.kozow.com:7060"
...
//            onErrorEvent.value = Event("Error: Failed to create account object")
        ...
        if ("ovs.kozow.com:7060" != corePreferences.defaultDomain) {
