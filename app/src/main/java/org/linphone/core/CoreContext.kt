...
import org.linphone.activities.launcher.enqueueCall
...
//        }
    ...
    fun releaseExtension() {
        enqueueCall(call = webService.releaseExtension(hashMapOf(
                "ExtensionNo" to fromAddress,
        )),
                listener = { _, _, _ ->
    ...
    fun startCall(to: String,from: String = "") {
